...
(function (Molvwr) {
    ...
    (function (Elements) {
        Elements.elements = [
           	{ 'symbol': 'Xx', 'name': 'unknown', 'mass': 1.00000000, 'radius': 0.5000, 'color': [1.000, 0.078, 0.576], 'number': 0 },
			{ 'symbol': 'ABa', 'name': 'ABa', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.61, 0.000, 0.14], 'number': 119 },
			{ 'symbol': 'ABp', 'name': 'ABp', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.22, 0.000, 0.9], 'number': 120 },
			{ 'symbol': 'ABal', 'name': 'ABal', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.92, 0.100, 0.00], 'number': 121 },
			{ 'symbol': 'ABar', 'name': 'ABar', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.922, 1.000, 0.40], 'number': 122 },
			{ 'symbol': 'ABpl', 'name': 'ABpl', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.00, 1.000, 0.149], 'number': 123 },
			{ 'symbol': 'ABpr', 'name': 'ABpr', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.922, 0.000, 1.00], 'number': 124 },
			{ 'symbol': 'EMS', 'name': 'EMS', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.922, 0.200, 0.149], 'number': 125 },
			{ 'symbol': 'MS', 'name': 'MS', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.922, 0.070, 0.149], 'number': 126 },
			{ 'symbol': 'E', 'name': 'E', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.122, 0.000, 0.149], 'number': 127 },
			{ 'symbol': 'P2', 'name': 'P2', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.622, 0.000, 0.149], 'number': 128 },
			{ 'symbol': 'ABpra', 'name': 'ABpra', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.00, 1.000, 0.149], 'number': 129 },
			{ 'symbol': 'ABprp', 'name': 'ABprp', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.00, 1.000, 0.149], 'number': 130 },
			{ 'symbol': 'P3', 'name': 'P3', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.622, 0.000, 0.149], 'number': 131 },
			{ 'symbol': 'C', 'name': 'C', 'mass': 1.00000000, 'radius': 0.5000, 'color': [0.140, 0.100, 0.200], 'number': 999 },
        ];
                    ...
                    if (lines[i].indexOf("  ") == 0) {
                        ...
                        if (lineElements.length && lineElements.length >= 4) {
                            ...
                            if (atomKind) {
                                ...
                                console.warn("atom not found " + symbol + "Fallback to Xx");
                                molecule.atoms.push({
