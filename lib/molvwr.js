    ...
    */
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
        Viewer.prototype._postProcessMolecule = function (molecule) {
            ...
            //molecule.bonds = [] // Fuck this line damn it 
...
(function (Molvwr) {
    ...
    (function (Elements) {
        ...
        Elements.elements.forEach(function (e) {
            ...
            Elements.MIN_ATOM_RADIUS = 0.5;
            Elements.MAX_ATOM_RADIUS = 0.5;
        });
                ...
                for (var i = 0, l = lines.length; i < l; i++) {
                    ...
                    if (lines[i].indexOf("  ") == 0 & lines[i].substr(0,4) == '    ') {
                        ...
                        if (lines[i].charAt(0) == 'B' & lines[i].charAt(1) == ' ') {
                            ...
                            var lineAtom = molecule.atoms[lineElements[1]-1];
                            var siblingAtom = molecule.atoms[lineElements[2]-1];
                            //var l = new BABYLON.Vector3(lineAtom.x, lineAtom.y, lineAtom.z);
                            //var m = BABYLON.Vector3(siblingAtom.x, siblingAtom.y, siblingAtom.z);
                            //var d = BABYLON.Vector3.Distance([lineAtom.x, lineAtom.y, lineAtom.z], [siblingAtom.x, siblingAtom.y, siblingAtom.z]);
                            var dx = Math.pow((siblingAtom.x-lineAtom.x),2);
                            var dy = Math.pow((siblingAtom.y-lineAtom.y),2);
                            var dz = Math.pow((siblingAtom.z-lineAtom.z),2);
                            ...
                            //console.log([lineAtom.x, lineAtom.y, lineAtom.z]);
                            //console.log([siblingAtom.x, siblingAtom.y, siblingAtom.z]);
                            //console.log([Math.pow((siblingAtom.x-lineAtom.x),2), Math.pow((siblingAtom.y-lineAtom.y),2), Math.pow((siblingAtom.z-lineAtom.z),2));
                            ///////////////////////////////////////
